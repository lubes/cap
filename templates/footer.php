    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-1 col-lg-1 col-xl-1">
                <figure>
                    <img src="<?php echo get_template_directory_uri();?>/dist/images/bcorp.png" class="img-fluid" />
                </figure>
            </div>
            ...
            <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                <a href="#" target="_blank" class="btn btn-blue btn-icon pull-right btn-lg">Client Login</a>
             </div>
        </div>
    </div>
</footer>
